...
const allEvents = [
  {
    ...
    time: "10h às 22h", location: "Centro de Convenções Vasco Vasques, Manaus",
  ...
  },
  {
    ...
    time: "14h às 23h", location: "Arena Poliesportiva, Manaus",
  ...
  },
  {
    ...
    time: "16h às 22h", location: "Praça da Saudade, Manaus",
    description: "Festival de cover dance com grupos de todo o Amazonas. Shows ao vivo, batalhas de dança, feira de photocards e álbuns, workshops de coreografia com dançarinos profissionais e área de fandom com decoração temática.",
    badge: "K-Pop", capacity: "2.500 pessoas",
  },
  {
    img: event4, title: "Workshop de Mangá e HQ", date: "20 JUL, 2024",
    time: "9h às 17h", location: "Biblioteca Pública do Amazonas",
  ...
  {
    img: newsConvention, title: "Noite Geek Manaus", date: "3 AGO, 2024",
    time: "19h às 3h", location: "Boulevard Manaus, Zona Centro-Sul",
  ...
  },
  {
    ...
    time: "10h às 20h", location: "Arena Poliesportiva, Manaus",
    description: "A maior competição de Valorant do Norte do Brasil, reunindo equipes do Amazonas, Pará, Roraima e Amapá. O campeão garante vaga direta no circuito nacional e premiação de R$ 15.000.",
    badge: "Torneio", capacity: "2.000 pessoas",
  },
  {
    img: newsKpop, title: "Manaus K-Culture Fest", date: "7 SET, 2024",
    time: "14h às 23h", location: "Centro Cultural Palácio da Justiça",
