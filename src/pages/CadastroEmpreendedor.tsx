  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-24 pb-16 px-6 max-w-3xl mx-auto">
        <div className="animate-fade-up">
          <h1 className="text-3xl md:text-4xl font-bold mb-2">Cadastro de Empreendedor</h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 animate-fade-up-delay-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Input id="name" placeholder="Nome do seu negócio" {...register("name")} />
              {errors.name && <p className="text-sm text-destructive">{errors.name.message}</p>}
            </div>
            <div className="space-y-2">
              <Label htmlFor="badge">Categoria *</Label>
              <Input id="badge" placeholder="Ex: Loja Geek, Gastronomia, Ateliê" {...register("badge")} />
